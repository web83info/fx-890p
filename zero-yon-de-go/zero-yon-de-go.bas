...
190 V=V+(V<0)*V:X=X+V/8:Q=2*((XÅ_3) MOD 6):DEFCHR$(252)=MID$(C$,13-Q,12):DEFCHR$(253)=MID$(C$,25-Q,12):DEFCHR$(254)=MID$(C$,37-Q,12):LOCATE XÅ_18,2:PRINT CHR$(29)" "CHR$(252)CHR$(253)CHR$(254):IF (X<500)*(X>0)*(V<>0) THEN 170 ELSE IF X=0 THEN 170
