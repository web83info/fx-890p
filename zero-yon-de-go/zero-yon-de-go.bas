...
120 LOCATE 5,0:PRINT REV" æﬁ € ÷ › √ﬁ    G O ! ":LOCATE 9,3:PRINT "PUSH SPACE KEY";
...
190 V=V+(V<0)*V:X=X+V/8:Q=2*(INT(X/3) MOD 6):DEFCHR$(252)=MID$(C$,13-Q,12):DEFCHR$(253)=MID$(C$,25-Q,12):DEFCHR$(254)=MID$(C$,37-Q,12):LOCATE INT(X/18),2:PRINT CHR$(29)" "CHR$(252)CHR$(253)CHR$(254):IF (X<500)*(X>0)*(V<>0) THEN 170 ELSE IF X=0 THEN 170
